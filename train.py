...
from model_torch.classification.drnn import DRNN
from model_torch.classification.fasttext import FastText
from model_torch.classification.textcnn import TextCNN
from model_torch.classification.textvdcnn import TextVDCNN
from model_torch.classification.textrnn import TextRNN
from model_torch.classification.textrcnn import TextRCNN
from model_torch.classification.transformer import Transformer
from model_torch.classification.dpcnn import DPCNN
from model_torch.classification.attentive_convolution import AttentiveConvNet
from model_torch.classification.region_embedding import RegionEmbedding
from model_torch.loss import ClassificationLoss
from model_torch.model_util import get_optimizer, get_hierar_relations
...
def get_classification_model(model_name, dataset, conf):
    """Get classification model_torch from configuration
    """
...
def train(conf):
    ...
    for epoch in range(conf.train.start_epoch,
        ...
        if performance > best_performance:  # record the best model_torch
            best_epoch = epoch
    ...
    # best model_torch on validateion set

...
from model.classification.textswem import SWEM
...
from model.model_util import  get_hierar_relations
from util import ModeType


ClassificationDataset, ClassificationCollator, FastTextCollator, ClassificationLoss, cEvaluator, TextCNN, TextRNN, TextRCNN,  TextVDCNN, Transformer, DPCNN,SWEM
...
def get_classification_model(model_name, conf):
    """Get classification model from configuration
    """
    model = globals()[model_name]( conf)
    return model
...
def train(conf):
    ...
    model = get_classification_model(model_name, conf)

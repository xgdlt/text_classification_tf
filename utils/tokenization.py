...
def convert_by_vocab(vocab, items):
    ...
    for item in items:
        ...
        output.append(vocab.get(item, 0))
    return output
...
def tokenize_word(text, do_lower_case=True):
    """Tokenizes a piece of text."""
    text = convert_to_unicode(text)
    text = _clean_text(text)
...
def word_piece_tokenize(text, vocab, unk_token="[UNK]", max_input_chars_per_word=100):

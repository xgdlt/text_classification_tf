...
from model_tf.embedding import Embedding
from model_tf.embedding import EmbeddingProcessType
from model_tf.embedding import EmbeddingType
from model_tf.embedding import RegionEmbeddingLayer
...
class Classifier(tf.keras.Model):
    def __init__(self, dataset, config):
        ...
        self.dropout = tf.keras.layers.Dropout(self.char_embedding )
